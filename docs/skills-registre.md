...
| Rust pointu / review | projet | session + `.claude/rules/rust.md` ; audit → agent `auditor` | async/perf/unsafe. Plus d'agent `rust-engineer` (rôle absorbé 2026-07-16). |
